...
void luxo_jr_joint_state_callback(const sensor_msgs::JointState& joint_state_msg);
ros::Subscriber<sensor_msgs::JointState> luxo_jr_sub("luxo_jr_joint_state", luxo_jr_joint_state_callback);
...
/*******************************************************************************
* Declaration for Luxo
*******************************************************************************/
LuxoJrController luxo_jr_controller;
float luxo_pos[4] = {330.0, 800.0, 700.0, 512.0};
/*******************************************************************************
* Declaration for IMU
*******************************************************************************/
cIMU imu;
...
void setup()
{
  ...
  // Luxo init
  luxo_jr_controller.init();
  luxo_jr_controller.positionControl(luxo_pos);
...
/*******************************************************************************
* Callback function for joint_state msg
*******************************************************************************/
void luxo_jr_joint_state_callback(const sensor_msgs::JointState& joint_state_msg)
{
  luxo_pos[0] = joint_state_msg.position[0];
  luxo_pos[1] = joint_state_msg.position[1];
  luxo_pos[2] = joint_state_msg.position[2];
  luxo_pos[3] = joint_state_msg.position[3];
}
