...
void initChain()
{
  ...
  chain[JOINT1].joint_pos_               << 0.0, 0.0, 0.054;
  ...
  chain[JOINT2].joint_pos_               << -0.0263, 0.0, 0.0658;
  ...
  chain[JOINT3].joint_pos_               << 0.0, 0.0, 0.075;

  chain[JOINT3].name_                    = "Joint4";
  chain[JOINT3].me_                      = JOINT4;
  chain[JOINT3].mother_                  = JOINT3;
  chain[JOINT3].sibling_                 = -1;
  chain[JOINT3].child_                   = GRIP;
  chain[JOINT3].p_                       = Eigen::Vector3f::Zero();
  chain[JOINT3].R_                       = Eigen::Matrix3f::Identity(3,3);
  chain[JOINT3].joint_angle_             = 0.0;
  chain[JOINT3].joint_vel_               = 0.0;
  chain[JOINT3].joint_acc_               = 0.0;
  chain[JOINT3].joint_axis_              << 0, 1, 0;
  chain[JOINT3].joint_pos_               << 0.012, 0.0, 0.0373;
  ...
  chain[GRIP].joint_pos_                 << 0.100, 0.0, 0.100;
}
